...
export default function DonationForm() {
  ...
  return (
    <div className="lg:col-span-3 bg-white rounded-xl shadow-lg p-4 border border-gray-100 h-fit">
      <h2 className="text-xl font-bold text-gray-800 mb-4 text-center bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text">
        Donate Now
      </h2>
