...
export default function StallBookingDetailsModal({
  show,
  booking,
  onClose,
  isDarkMode
        ...
        <div className={`relative max-w-3xl w-full mx-auto rounded-xl shadow-2xl overflow-hidden transform transition-all z-[70] ${
          ...
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center">
              <StopIcon className="w-6 h-6 text-white mr-3" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Business Type:</span>
                    <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Stalls:</span>
                    <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
