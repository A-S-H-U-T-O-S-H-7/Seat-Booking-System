...
export default function StallPaymentDetailsModal({
  show,
  booking,
  onClose,
  onViewFullDetails,
          ...
          <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                {booking.payment && (
                  <>
                    ...
                    <div>
                      <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Payment Date:</span>
                      <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                        {booking.payment.timestamp ? formatDate(booking.payment.timestamp) : 'N/A'}
                      </p>
                    </div>
                  </>
                )}
            ...
            <div className={`p-4 rounded-lg ${
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center">
                  <span className={`text-sm ${isDarkMode ? 'text-blue-400' : 'text-blue-700'}`}>Vendor:</span>
                  <span className={`text-sm ${isDarkMode ? 'text-blue-300' : 'text-blue-900'}`}>
                    {booking.vendorDetails?.name || 'N/A'}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className={`text-sm ${isDarkMode ? 'text-blue-400' : 'text-blue-700'}`}>Stalls:</span>
                  <span className={`text-sm ${isDarkMode ? 'text-blue-300' : 'text-blue-900'}`}>
