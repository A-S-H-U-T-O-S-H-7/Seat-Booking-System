...
export default function HavanPriceSection({ settings, onUpdate, isDarkMode }) {
  // Havan seat pricing
    ...
    <div className="space-y-6">
      ...
      <div className={`p-4 sm:p-6 rounded-xl border ${
        ...
        <h3 className={`text-base sm:text-lg font-semibold mb-4 flex items-center ${
          ...
          <MagnifyingGlassIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-amber-500 flex-shrink-0" />
          <span className="truncate">Havan Seat Pricing</span>
        </h3>
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base rounded-lg border transition-colors focus:ring-2 focus:ring-amber-500 focus:border-transparent ${
                isDarkMode 
